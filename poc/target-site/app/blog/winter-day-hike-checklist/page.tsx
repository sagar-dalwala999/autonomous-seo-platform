...
/* seeded: near-duplicate content pair with /blog/winter-hiking-checklist, ~90% identical (manifest #18) */
export const metadata: Metadata = {
  title: "Winter Day-Hike Checklist | Summit Trail Gear",
  description:
    "The winter checklist we run before every cold-season day hike: clothing, traction, light, food, and a turnaround time.",
};

export default function WinterDayHikeChecklistPage() {
  return (
    <article>
      <h1>Winter day-hike checklist</h1>
      <p>
        ...
        checklist before every cold-season day hike, without exception, even on trails we know
        well.
      </p>
      <h2>Clothing</h2>
      <p>
      ...
      <p>
        Cold suppresses thirst, so drink on a schedule, and pack more calories than a summer outing
        needs. Set a hard turnaround time before you leave the trailhead and honor it. The summit
        is optional; the parking lot is mandatory.
      </p>
    </article>
  );
}
